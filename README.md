...
# WIF3001Drone4DengueTests

A repository that holds the test scripts for testing the Drone4Dengue Application
...
├── drone4dengue-tests/     # E2E tests (pytest, Selenium, Appium) — see drone4dengue-tests/README.md
